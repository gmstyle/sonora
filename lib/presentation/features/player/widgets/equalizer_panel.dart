...
class EqualizerPanel extends ConsumerWidget {
  ...
  const EqualizerPanel({super.key, this.isDialog = false});

  static Future<void> show(BuildContext context) {
    final width = MediaQuery.of(context).size.width;
    final isWide = width >= kExpandedBreakpoint; // Wide / Desktop

    if (isWide) {
      return showDialog(
        context: context,
        builder:
            (context) => const Dialog(child: EqualizerPanel(isDialog: true)),
      );
    } else {
      return showModalBottomSheet(
        ...
        builder: (context) => const EqualizerPanel(isDialog: false),
      );
    }
  }
      ...
      children: [
        ...
        Row(
          ...
          children: [
            Row(
              children: [
                Icon(LucideIcons.sliders, color: theme.colorScheme.primary),
