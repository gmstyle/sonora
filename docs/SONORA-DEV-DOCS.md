...
│   ├── datasources/
│   │   ├── local/
│   │   │   ├── database.dart           # Drift AppDatabase (schema v10)
...
### 3.2 Provider Naming Convention
...
## 5. Audio Engine — Important Details
...
### 5.3 MediaItem.extras — Convention
...
## 8. Dynamic API Fields (Not Persisted)
...
### 8.2 Helpers in `stat_format.dart`
...
## 11. Settings — Persistent Preferences
...
## 17. Checklist for Common Changes
