...
void main() {
  group('DurationFormat extension', () {
    ...
    test('format() should format durations more than an hour', () {
      expect(
        const Duration(hours: 1, minutes: 0, seconds: 0).format(),
        '1:00:00',
      );
      expect(
      ...
      expect(
        const Duration(hours: 10, minutes: 59, seconds: 59).format(),
        '10:59:59',
      );
      expect(
        const Duration(hours: 176, minutes: 10, seconds: 0).format(),
        '176:10:00',
      );
    });
